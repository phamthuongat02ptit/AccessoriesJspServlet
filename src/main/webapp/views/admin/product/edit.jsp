                ...
                <div class="col-xs-12">
                	<c:if test="${not empty messageResponse}">
                        ...
                        <form id="formSubmit">
                            ...
                            <br/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Gía mới</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="priceNew" name="priceNew" value="${model.priceNew}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Gía cũ</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="priceOld" name="priceOld" value="${model.priceOld}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Điểm đánh giá</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="evaluate" name="evaluate" value="${model.evaluate}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
